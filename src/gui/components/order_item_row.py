...
class OrderItemRow:
    ...
    def __init__(self, parent: tk.Widget, item: Item) -> None:
        ...
        self.blocks_var.trace("w", self._on_blocks_change)
        self.servings_var.trace("w", self._on_servings_change)
        self.sale_var.trace("w", self._on_amount_change)
        self.discount_var.trace("w", self._on_amount_change)
        self.coupon_var.trace("w", self._on_amount_change)
